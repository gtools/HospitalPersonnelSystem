    ...
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ComGender>()
                ...
                {
                    Code = Guid.Parse("{7fad4261-11ce-451c-a975-3ae5a7d7d735}"),
                    Name = "男",
                    Spell = "N",
                    Sort = 0
                }, new ComGender
                {
                    Code = Guid.Parse("{1a204e5f-0c6e-48d1-b277-ae2d1e25d647}"),
                    Name = "女",
                    Spell = "N",
                    Sort = 1
                }, new ComGender
                {
                    Code = Guid.Parse("{7897f820-7446-4356-a8df-4f1b5126faf4}"),
                    Name = "未知",
                    Spell = "WZ",
                    Sort = 2
                });
            ...
            //    }, new SysItem
            //    {
            //        ItemCode = Guid.Parse("{8b2fc9dd-ce60-436e-b6b0-8b03d4170415}"),
            //        ItemName = "政治面貌",
            //        Spell = "ZZMM"
            //    });
            //#endregion
            ...
            //    {
            //        ItemCode = Guid.Parse("{8b2fc9dd-ce60-436e-b6b0-8b03d4170415}"),
            //        ItemKey = Guid.Parse("{4f088716-0000-0000-0000-000000000001}"),
            //        ItemValue = "中共党员",
            //        Spell = "ZGDY"
            //    }, new SysItemInfo
            //    {
            //        ItemCode = Guid.Parse("{8b2fc9dd-ce60-436e-b6b0-8b03d4170415}"),
            //        ItemKey = Guid.Parse("{4f088716-0000-0000-0000-000000000002}"),
            //        ItemValue = "中共预备党员",
            //        Spell = "ZGYBDY"
            //    }, new SysItemInfo
            //    {
            //        ItemCode = Guid.Parse("{8b2fc9dd-ce60-436e-b6b0-8b03d4170415}"),
            //        ItemKey = Guid.Parse("{4f088716-0000-0000-0000-000000000003}"),
            //        ItemValue = "共青团员",
            //        Spell = "GQTY"
            //    }, new SysItemInfo
            //    {
            //        ItemCode = Guid.Parse("{8b2fc9dd-ce60-436e-b6b0-8b03d4170415}"),
            //        ItemKey = Guid.Parse("{4f088716-0000-0000-0000-000000000004}"),
            //        ItemValue = "民革党员",
            //        Spell = "MGDY"
            //    }, new SysItemInfo
            //    {
            //        ItemCode = Guid.Parse("{8b2fc9dd-ce60-436e-b6b0-8b03d4170415}"),
            //        ItemKey = Guid.Parse("{4f088716-0000-0000-0000-000000000005}"),
            //        ItemValue = "民盟盟员",
            //        Spell = "MMMY"
            //    }, new SysItemInfo
            //    {
            //        ItemCode = Guid.Parse("{8b2fc9dd-ce60-436e-b6b0-8b03d4170415}"),
            //        ItemKey = Guid.Parse("{4f088716-0000-0000-0000-000000000006}"),
            //        ItemValue = "民建会员",
            //        Spell = "MJHY"
            //    }, new SysItemInfo
            //    {
            //        ItemCode = Guid.Parse("{8b2fc9dd-ce60-436e-b6b0-8b03d4170415}"),
            //        ItemKey = Guid.Parse("{4f088716-0000-0000-0000-000000000007}"),
            //        ItemValue = "民进会员",
            //        Spell = "MJHY"
            //    }, new SysItemInfo
            //    {
            //        ItemCode = Guid.Parse("{8b2fc9dd-ce60-436e-b6b0-8b03d4170415}"),
            //        ItemKey = Guid.Parse("{4f088716-0000-0000-0000-000000000008}"),
            //        ItemValue = "农工党党员",
            //        Spell = "NGDDY"
            //    }, new SysItemInfo
            //    {
            //        ItemCode = Guid.Parse("{8b2fc9dd-ce60-436e-b6b0-8b03d4170415}"),
            //        ItemKey = Guid.Parse("{4f088716-0000-0000-0000-000000000009}"),
            //        ItemValue = "致公党党员",
            //        Spell = "ZGDDY"
            //    }, new SysItemInfo
            //    {
            //        ItemCode = Guid.Parse("{8b2fc9dd-ce60-436e-b6b0-8b03d4170415}"),
            //        ItemKey = Guid.Parse("{4f088716-0000-0000-0000-000000000010}"),
            //        ItemValue = "九三学社社员",
            //        Spell = "JSXSSY"
            //    }, new SysItemInfo
            //    {
            //        ItemCode = Guid.Parse("{8b2fc9dd-ce60-436e-b6b0-8b03d4170415}"),
            //        ItemKey = Guid.Parse("{4f088716-0000-0000-0000-000000000011}"),
            //        ItemValue = "台盟盟员",
            //        Spell = "WMMY"
            //    }, new SysItemInfo
            //    {
            //        ItemCode = Guid.Parse("{8b2fc9dd-ce60-436e-b6b0-8b03d4170415}"),
            //        ItemKey = Guid.Parse("{4f088716-0000-0000-0000-000000000012}"),
            //        ItemValue = "无党派人士",
            //        Spell = "WDPRS"
            //    }, new SysItemInfo
            //    {
            //        ItemCode = Guid.Parse("{8b2fc9dd-ce60-436e-b6b0-8b03d4170415}"),
            //        ItemKey = Guid.Parse("{4f088716-0000-0000-0000-000000000013}"),
            //        ItemValue = "群众",
            //        Spell = "QZ"
            //    });
            //#endregion
